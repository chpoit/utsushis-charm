...
_resources = {
    ...
    "lv5": _alter_resource_path(os.path.join("images", "levels", "lv5.png")),
    "lv6": _alter_resource_path(os.path.join("images", "levels", "lv6.png")),
    "lv7": _alter_resource_path(os.path.join("images", "levels", "lv7.png")),
